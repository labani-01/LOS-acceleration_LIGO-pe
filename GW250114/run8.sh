#!/bin/bash
#SBATCH --job-name=GW250114_10
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=32
#SBATCH --cpus-per-task=1
#SBATCH --mem=128G
#SBATCH --time=8-00:00:00
#SBATCH --output=inference_nonzero_a10.out
...
mpirun -np $SLURM_NTASKS -- pycbc_inference \
	--config-file /home/lroy02/acceleration_runs/separate_runs/GW250114/config_nonzero_a10.ini \
	--output-file /home/lroy02/acceleration_runs/separate_runs/GW250114/inference_nonzero_a10.hdf \
