#!/bin/bash
#SBATCH --job-name=GW170817_acc
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=32
#SBATCH --cpus-per-task=1
#SBATCH --mem=256G
#SBATCH --time=14-00:00:00
#SBATCH --output=inference_GW170817_nonzero_a23.out
...
conda activate ground_acc_env2


# ------------------ Launch PyCBC Inference ------------------

mpirun -np $SLURM_NTASKS -- pycbc_inference \
        --config-file /home/lroy02/acceleration_runs/separate_runs/GW170817/config_nonzero_a_IMRPhenomD_NRTidal.ini \
        --output-file /home/lroy02/acceleration_runs/separate_runs/GW170817/inference_nonzero_a_IMRPhenomD_NRTidal.hdf \
