...
#SBATCH --output=inference_mass_constraint_IMRPhenomNSBH7.out
...
mpirun -np $SLURM_NTASKS -- pycbc_inference \
	--config-file /home/lroy02/acceleration_runs/separate_runs/GW230518/config_nonzero_a7.ini \
	--output-file /home/lroy02/acceleration_runs/separate_runs/GW230518/inference_nonzero_a_mass_constraint_IMRPhenomNSBH7.hdf \
