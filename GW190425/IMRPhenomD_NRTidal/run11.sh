...
#SBATCH --output=inference_GW190425_nonzero_a11.out
...
conda activate ground_acc_env


# ------------------ Launch PyCBC Inference ------------------

mpirun -np $SLURM_NTASKS -- pycbc_inference \
	--config-file /home/lroy02/acceleration_runs/separate_runs/GW190425/config_nonzero_a11.ini \
	--output-file /home/lroy02/acceleration_runs/separate_runs/GW190425/inference_nonzero_a11.hdf \
	--verbose --use-mpi
