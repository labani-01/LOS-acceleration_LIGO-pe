...
#SBATCH --output=inference_mass_constraint_IMRNSBH8.out
...
conda activate ground_acc_env2_mass_constraint


# ------------------ Launch PyCBC Inference ------------------

mpirun -np $SLURM_NTASKS -- pycbc_inference \
	--config-file /home/lroy02/acceleration_runs/separate_runs/GW200115/config_nonzero_a_mass_constraint_IMRNSBH8.ini \
	--output-file /home/lroy02/acceleration_runs/separate_runs/GW200115/inference_nonzero_a_mass_constraint_IMRNSBH8.hdf \
