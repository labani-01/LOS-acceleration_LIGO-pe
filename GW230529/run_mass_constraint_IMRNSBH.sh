...
#SBATCH --output=inference_mass_constraint_IMRNSBH6.out
...
mpirun -np $SLURM_NTASKS -- pycbc_inference \
	--config-file /home/lroy02/acceleration_runs/separate_runs/GW230529/config_nonzero_a6.ini \
	--output-file /home/lroy02/acceleration_runs/separate_runs/GW230529/inference_nonzero_a_mass_constraint_IMRNSBH6.hdf \
