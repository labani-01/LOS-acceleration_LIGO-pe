#!/bin/bash
#SBATCH --job-name=GW241011
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=32
#SBATCH --cpus-per-task=1
#SBATCH --mem=256G
#SBATCH --time=8-00:00:00
#SBATCH --output=inference_nonzero_a2.out
...
conda activate activate ground_acc_env2_ecc


# ------------------ Launch PyCBC Inference ------------------

mpirun -np $SLURM_NTASKS -- pycbc_inference \
	--config-file /home/lroy02/acceleration_runs/separate_runs/GW241011_233834/config_nonzero_a2.ini \
	--output-file /home/lroy02/acceleration_runs/separate_runs/GW241011_233834/inference_nonzero_a2.hdf \
