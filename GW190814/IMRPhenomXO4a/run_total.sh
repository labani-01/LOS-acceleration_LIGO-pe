#!/bin/bash
#SBATCH --job-name=XO4a_total
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=32
#SBATCH --cpus-per-task=1
#SBATCH --mem=256G
#SBATCH --time=7-00:00:00
#SBATCH --output=/home/lroy02/acceleration_runs/separate_runs/GW190814/split_run/IMRPhenomXO4a_L1/logs/acc_total.out
...
mpirun -np $SLURM_NTASKS -- pycbc_inference \
	--config-file /home/lroy02/acceleration_runs/separate_runs/GW190814/split_run/IMRPhenomXO4a_L1/runs/acc_0p007/config_total.ini \
	--output-file /home/lroy02/acceleration_runs/separate_runs/GW190814/split_run/IMRPhenomXO4a_L1/runs/acc_0p007/result_total.hdf \
