...
#SBATCH --output=inference_common.out
...
mpirun -np $SLURM_NTASKS -- pycbc_inference \
	--config-file /home/lroy02/acceleration_runs/GW200105_runs/base/common_config.ini \
	--output-file /home/lroy02/acceleration_runs/GW200105_runs/base/inference_common.hdf \
