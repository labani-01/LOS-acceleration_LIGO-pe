#!/bin/bash
#SBATCH --job-name=SEOBHM
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=32
#SBATCH --cpus-per-task=1
#SBATCH --mem=256G
#SBATCH --time=8-00:00:00
#SBATCH --output=inference_nonzero_a_SEOBNRv5HM.out
...
mpirun -np $SLURM_NTASKS -- pycbc_inference \
	--config-file /home/lroy02/acceleration_runs/separate_runs/GW200105/config_nonzero_a_SEOBNRv5HM.ini \
	--output-file /home/lroy02/acceleration_runs/separate_runs/GW200105/inference_nonzero_a_SEOBNRv5HM.hdf \
